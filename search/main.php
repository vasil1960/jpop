...
<!-- InstanceBeginEditable name="LeftSidebar" -->
    ...
    <div id="mainContent">
      <div id="frmSearch_ProgressWrapper">
        <form id="frmSearch" name="frmSearch" method="post" action="search_result.php">
          <span class="title">Search</span>
          <hr />
          <div id="divSearch">
            <p>Search in authors<em><strong> First Name</strong></em>, <em><strong>Last Name,  First Name </strong></em>+ <em><strong>Last Name</strong></em> and manuscripts <em><strong>Full Tittle Name</strong></em>, <em><strong>Abstract</strong></em> and <em><strong>Keywords</strong></em></p>
            <p>
              <label for="txtSearch"></label>
              <textarea name="txtSearch" id="txtSearch" cols="140" rows="7"></textarea>
               </p>
            <p>
              <input type="submit" name="btnSearch" id="btnSearch" value="   Search   " />
              <input type="reset" name="btnClear" id="btnClear" value="   Clear Text   " />
            </p>
          </div>
        </form>
      </div>
    </div>
    <div id="frmSearch_ProgressMessageWrapper" class="blockUIOverlay" style="display:none;">
      <script type="text/javascript">
WADFP_SetProgressToForm('frmSearch', 'frmSearch_ProgressMessageWrapper', WADFP_Theme_Options['BigSpin:GranitePine']);
    </script>
      <div id="frmSearch_ProgressMessage" >
        <p style="margin:10px; padding:5px;" ><img src="../webassist/progress_bar/images/granite-largespin.gif" alt="" title="" style="vertical-align:middle;" />&nbsp;&nbsp;Please wait</p>
      </div>
    </div>
    <!-- InstanceEndEditable --></div>
  </div>

...
$colname_rsUsersProfile = "-1";
if (isset($_GET['profile'])) {
  $colname_rsUsersProfile = (get_magic_quotes_gpc()) ? $_GET['profile'] : addslashes($_GET['profile']);
}
mysql_select_db($database_localhost, $localhost);
$query_rsUsersProfile = sprintf("SELECT * FROM users WHERE users.UserID=%s", GetSQLValueString($colname_rsUsersProfile, "int"));
$rsUsersProfile = mysql_query($query_rsUsersProfile, $localhost) or die(mysql_error());
$row_rsUsersProfile = mysql_fetch_assoc($rsUsersProfile);
$totalRows_rsUsersProfile = mysql_num_rows($rsUsersProfile);
?>
<?php
      ...
      <div id="mainContent">
        <form id="form1" name="form1" method="post" action="">
           ...
           <table width="100%" border="0" cellpadding="0" cellspacing="4">
             <tr>
               <td width="13%"><strong>User ID:</strong></td>
               <td width="87%"><?php echo $row_rsUsersProfile['UserID']; ?></td>
             </tr>
             <tr>
               <td><strong>  Name:</strong></td>
               <td><?php echo $row_rsUsersProfile['UserFirstName']; ?> <?php echo $row_rsUsersProfile['UserLastName']; ?></td>
             </tr>
             <tr>
               <td><strong>City:</strong></td>
               <td><?php echo $row_rsUsersProfile['UserCity']; ?></td>
             </tr>
             <tr>
               <td><strong>Country:</strong></td>
               <td><?php echo $row_rsUsersProfile['UserCountry']; ?></td>
             </tr>
             <tr>
               <td><strong>Address:</strong></td>
               <td><?php echo $row_rsUsersProfile['UserAddress']; ?></td>
             </tr>
             <tr>
               <td><strong>Email: </strong></td>
               <td><?php echo $row_rsUsersProfile['UserEmail']; ?></td>
             </tr>
             <tr>
               <td><strong>Registered on:</strong></td>
               <td><?php echo $row_rsUsersProfile['UserRegistrationDate']; ?></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsUsersProfile);
?>

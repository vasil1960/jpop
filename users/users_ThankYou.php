...
<!-- InstanceEndEditable --></div>
    ...
    <h3 class="title">Thank you for your registration
    </h3>
    <div id="mainContent">
      <form id="form1" name="form1" method="post" action="">
      <p> You will need to validate your email by clicking on the link sent to the email address you used for registration before gaining access.</p>
</form>
</div>
  <!-- InstanceEndEditable --></div>
  </div>

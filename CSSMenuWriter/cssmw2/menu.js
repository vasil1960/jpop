...
var cssmw2 = {
	...
	ie6_li_mouseOver: function(e) {
		cssmw2.clearHoverLIs();
		cssmw2.setHovFocLI(this, "hoverLI");
		var doBlur = (cssmw2.focusLI && true);
		cssmw2.clearFocusLIs();
		if (doBlur) {
			cssmw2.blurFocus();
			cssmw2.clearFocus();
		}
		cssmw2.setLIAndChildNodes(this, "link", "hover");
	...
	ie6_li_mouseOut: function(e) {
		cssmw2.clearHoverLIs();
		var ul = this.getElementsByTagName('ul')[0];
		cssmw2.setLIAndChildNodes(this, "hover", "link");
	...
	a_focus: function(e) {
		...
		if (!li) return;
		cssmw2.clearFocusLIs();
		cssmw2.setHovFocLI(li, "focusLI");
		cssmw2.setLIAndChildNodes(li, "link", "hover");
		if (cssmw2.browser.isIE6) {
			var ul = cssmw2.localGetElementsByTagName(li, 'ul')[0];
			if(ul) ul.style.display = 'block';
		}
	},
	...
	a_blur: function(e) {
		...
		if (cssmw2.focusLI) {
			cssmw2.remHovFocLI(cssmw2.focusLI, "focusLI");
		}
		setTimeout("cssmw2.clearFocus();", 1);
	},

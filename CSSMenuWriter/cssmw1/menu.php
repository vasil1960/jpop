...
<li><a href="<?php echo($assumedRoot); ?>manuscripts/mscr_Reviewer.php">Manuscripts for review</a></li>
<li><a href="<?php echo($assumedRoot); ?>users/users_Logout.php">Logout</a></li>
</ul>

<script type="text/javascript">if(window.attachEvent) { window.attachEvent("onload", function() { cssmw1.intializeMenu('cssmw1',{select_current: 1, orientation: 2}); }); } else if(window.addEventListener) { window.addEventListener("load", function() { cssmw1.intializeMenu('cssmw1',{select_current: 1, orientation: 2}); }, true); }</script>
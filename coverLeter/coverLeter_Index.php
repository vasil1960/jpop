...
?>
<?php
$rsCoverLeter = new WA_MySQLi_RS("rsCoverLeter",$localhost_i,1);
$rsCoverLeter->setQuery("SELECT mnscrpts.mscrID, mnscrpts.mscrCodeU, mnscrpts.mscrUpldDate, mnscrpts.mscrFullTitle, users.UserID, CONCAT(users.UserFirstName,' ', users.UserLastName) AS AutorFullName, mnscrpts.mscrCoverLeter FROM mnscrpts, users WHERE mnscrpts.mscrID=? AND mnscrpts.mscrAutorID=users.UserID");
$rsCoverLeter->bindParam("i", "".($_GET['mnscrpt_id'])  ."", "-1"); //colname
$rsCoverLeter->execute();
?>
<?php
@session_start();
if ("" === "")     {
        ...
        <form id="form1" name="form1" method="post" action="">
           ...
           <table width="70%" border="0" cellspacing="3" cellpadding="0">
             <tr>
               ...
               <td width="85%"><?php echo $rsCoverLeter->getColumnVal('mscrCodeU'); ?></td>
             </tr>
             <tr>
               <td><strong>Title:</strong></td>
               <td><?php echo $rsCoverLeter->getColumnVal('mscrFullTitle'); ?></td>
             </tr>
             <tr>
               <td><strong>Autor:</strong></td>
               <td><?php echo $rsCoverLeter->getColumnVal('AutorFullName'); ?></td>
             </tr>
             <tr>
               <td><strong>Date:</strong></td>
               <td><?php echo $rsCoverLeter->getColumnVal('mscrUpldDate'); ?></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             ...
             <tr>
               <td valign="top"><strong>Cover Letter:</strong></td>
               <td><?php echo $rsCoverLeter->getColumnVal('mscrCoverLeter'); ?></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>

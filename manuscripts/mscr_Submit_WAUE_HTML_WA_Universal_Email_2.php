...
if (isset($_SESSION['UserID'])) {
  $colname_rsAutorFullName = $_SESSION['UserID'];
}
mysql_select_db($database_localhost, $localhost);
...
<html><!-- InstanceBegin template="/Templates/waue html body" codeOutsideHTMLIsLocked="false" --><head><!-- InstanceBeginEditable name="emailhead" --><!-- InstanceEndEditable --></head><body><!-- InstanceBeginEditable name="emailbody" -->Hi Editor,<br/>
<?php echo $_SESSION['UserFirstName']?> <?php echo $_SESSION['UserLastName']?> <br/>
has send and upload manuscript with title "<?php echo ((isset($_POST["txtFullTitle"]))?$_POST["txtFullTitle"]:"")?>\" to the system<!-- InstanceEndEditable --></body><!-- InstanceEnd --></html>
<?php

...
<p>Dear Dr. <?php echo $row_rsReviewer_1['ReviewerFullName']?>,<br />
<br />
...
<br />
<br />
<a href="http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer1ConfirmYes.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']?>&code=<?php echo $_SESSION['confirmYes']?>">I agree to review this submission.</a>
  <br /><br />
  If you do not have time to do this, or do not feel qualified, please click on this link:
  <br />
  <br />
<a href="http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer1ConfirmNo.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']?>&code=<?php echo $_SESSION['confirmNo']?>">I decline to review this submission.</a></p>
<p>(If you can't click on the links please select it, copy and paste into the browser adderss and press &quot;Enter&quot;)<br />
  <br />
  We   hope you are willing to review the manuscript. If so, would you be so   kind as to return your review to us within 21 days of agreeing to   review? Thank you.<br />
  <br />

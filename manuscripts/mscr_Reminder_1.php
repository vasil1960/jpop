...
$colname_rsReminder_1 = "-1";
if (isset($_GET['mnscrpt_id'])) {
  $colname_rsReminder_1 = $_GET['mnscrpt_id'];
}
mysql_select_db($database_localhost, $localhost);
$query_rsReminder_1 = sprintf("SELECT mnscrpts.mscrID, mnscrpts.mscrFullTitle, mnscrpts.mscrCodeU, mnscrpts.mscrReviewer_1, users.UserID, users.UserEmail AS EmailReviewer_1, users.UserFirstName, users.UserLastName,mnscrDateConfirm_1,mnscrpts.mscrDateToReviewer_1 FROM mnscrpts, users WHERE mnscrpts.mscrID = %s AND mnscrpts.mscrReviewer_1 = users.UserID ", GetSQLValueString($colname_rsReminder_1, "int"));
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><label for="txtReminder"></label>
                <textarea name="txtReminder" id="txtReminder" cols="95" rows="18"><p>Dear Dr. <?php echo $row_rsReminder_1['UserFirstName']; ?> <?php echo $row_rsReminder_1['UserLastName']; ?>,</p>
<p>You agreed to review manuscript <?php echo $row_rsReminder_1['mscrCodeU']; ?> ( "<?php echo $row_rsReminder_1['mscrFullTitle']; ?>" ) and your completed review was due by <?php echo splitDate($row_rsReminder_1['mscrDateToReviewer_1']) ; ?>.</p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsReminder_1);
?>

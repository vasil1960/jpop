...
if (!($totalRows_rsConfirmNo == 0)) // Trigger
{
  ...
  $WA_fieldNamesStr = "mnscConfirmReviewer_1|mnscrCodeConfirmYes_1|mnscrCodeConfirmNo_1|mscrReviewer_1|mscrReviewerFullName_1";
  $WA_fieldValuesStr = "Not confirm" . $WA_AB_Split . "".WA_RandomPassword(6, true, true, true, "")  ."" . $WA_AB_Split . "".WA_RandomPassword(6, true, true, true, "")  ."" . $WA_AB_Split . "NULL" . $WA_AB_Split . "Reviewer 1";
    ...
    <div id="content"><!-- InstanceBeginEditable name="mainContent" -->
      ...
      <div id="mainContent">
        <form id="form1" name="form1" method="post" action="">
           ...
           <hr />
          <p>You have NOT confirm to review the manuscript No <strong><?php echo $row_rsConfirmNo['mscrCodeU']; ?></strong>. You answer is <strong>NO</strong>.<br />

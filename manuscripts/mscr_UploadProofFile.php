...
if ($_SERVER["REQUEST_METHOD"] == "POST")  {
  $WAFV_Redirect = "";
  $_SESSION['WAVT_mscrUploadProofFile_758_Errors'] = "";
  if ($WAFV_Redirect == "")  {
    $WAFV_Redirect = $_SERVER["PHP_SELF"];
  }
  $WAFV_Errors = "";
  $WAFV_Errors .= WAValidateRQ(((isset($_FILES["txtUploadProofFile"]))?$_FILES["txtUploadProofFile"]["name"]:"") . "",false,1);
  $WAFV_Errors .= WAValidateRQ(((isset($_FILES["txtLeterFromEditor"]))?$_FILES["txtLeterFromEditor"]["name"]:"") . "",false,2);

  if ($WAFV_Errors != "")  {
    PostResult($WAFV_Redirect,$WAFV_Errors,"mscrUploadProofFile_758");
  }
}
?>
...
if (isset($_GET["mscr_id"])) {
  $colname_Recordset1 = $_GET["mscr_id"];
}
mysql_select_db($database_localhost, $localhost);
$query_Recordset1 = sprintf("SELECT mnscrpts.mscrID, mnscrpts.mscrAutorID, mnscrpts.mscrFullTitle, mnscrpts.mscrCodeU, mnscrpts.mscrEditorsLetter, users.UserEmail, CONCAT(users.UserFirstName,' ', users.UserLastName) AS FullAutorName, mnscrpts.mscrUpldDate, mnscrpts.mscrUploadProofFile, mnscrpts.mscrUploadProofDate FROM mnscrpts, users WHERE mnscrpts.mscrAutorID=users.UserID AND mnscrpts.mscrID=%s", GetSQLValueString($colname_Recordset1, "int"));
...
$WA_UploadResult1_Params["WA_UploadResult1_1"] = array(
	'UploadFolder' => "../files/proof/",
	'FileName' => "".$row_Recordset1['mscrCodeU']  ."(proof)",
	'DefaultFileName' => "",
	'ResizeType' => "0",
	'ResizeWidth' => "0",
	'ResizeHeight' => "0",
...
$WA_UploadResult2_Params["WA_UploadResult2_1"] = array(
	...
	'FileName' => "".$row_Recordset1['mscrCodeU']  ."(ProofEditorsLetter)",
	'DefaultFileName' => "",
	'ResizeType' => "0",
	'ResizeWidth' => "0",
	'ResizeHeight' => "0",
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	WA_DFP_UploadFiles("WA_UploadResult1", "txtUploadProofFile", "0", "", "false", $WA_UploadResult1_Params);
}?>
<?php
WA_DFP_SetupUploadStatusStruct("WA_UploadResult2");
if($_SERVER["REQUEST_METHOD"] == "POST"){
	WA_DFP_UploadFiles("WA_UploadResult2", "txtLeterFromEditor", "0", "", "false", $WA_UploadResult2_Params);
}
?>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") // Trigger
{
  ...
  $WA_fieldNamesStr = "mscrUploadProofFile|mscrUploadProofDate|mscrUploadProofEditorsFile|mscrUploadProofEditorsFileDate";
  $WA_fieldValuesStr = "".$WA_DFP_UploadStatus["WA_UploadResult1"]["serverFileName"]  ."" . $WA_AB_Split . "".((isset($_POST["dateNow"]))?$_POST["dateNow"]:"")  ."" . $WA_AB_Split . "".$WA_DFP_UploadStatus["WA_UploadResult2"]["serverFileName"]  ."" . $WA_AB_Split . "".((isset($_POST["dateNow"]))?$_POST["dateNow"]:"")  ."";
  ...
  $WA_where_fieldValuesStr = "".$row_Recordset1['mscrID']  ."";
...
if ((WA_DFP_AllUploadsSuccess()))     {
  ...
  @session_write_close();
  set_time_limit(0);
  $EmailRef = "waue_mscr_UploadProofFile_1";
  $BurstSize = 200;
  $BurstTime = 1;
  $WaitTime = 1;
  $GoToPage = "mscr_UploadProofFileSuccess.php";
  $RecipArray = array();
  $StartBurst = time();
  $LoopCount = 0;
  $TotalEmails = 0;
  ...
  while ($RecipIndex < sizeof($RecipArray))  {
    ...
    while (($EnteredValue && $CurIndex < sizeof($RecipArray[$RecipIndex])) || (!$EnteredValue && $RecipArray[$RecipIndex][0])) {
      ...
      wa_sleep($WaitTime);
      include("../webassist/email/waue_mscr_UploadProofFile_1.php");
    ...
    <div id="mainContent">
      <div id="form1_ProgressWrapper">
        <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <span class="title">Upload Proof File</span>
          <hr />
          <div id="uploadProofFile">
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
              <tr>
                <td width="12%" rowspan="2" align="center" bgcolor="#FEED77"><?php echo $row_rsEditorsLeter['mscrCodeU']; ?><?php echo $row_Recordset1['mscrCodeU']; ?></td>
                <td width="61%" rowspan="2" bgcolor="#CCCCCC"><?php echo $row_Recordset1['mscrFullTitle']; ?></td>
                <td width="27%" align="center" bgcolor="#CCCCCC"><?php echo $row_Recordset1['FullAutorName']; ?></td>
                </tr>
              <tr>
                <td align="center" bgcolor="#CCCCCC"><?php echo $row_Recordset1['mscrUpldDate']; ?></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td align="right" valign="top">Proof:</td>
                <td><label for="txtUploadProofFile"></label>
                  <input name="txtUploadProofFile" type="file" id="txtUploadProofFile" size="40" />
                  <br />
                  <?php
if (ValidatedField('mscrUploadProofFile_758','mscrUploadProofFile_758'))  {
  if ((strpos((",".ValidatedField("mscrUploadProofFile_758","mscrUploadProofFile_758").","), "," . "1" . ",") !== false || "1" == ""))  {
    if (!(false))  {
?>
                    <span class="validation_text">Please select proof file.</span>
                  <?php //WAFV_Conditional mscr_UploadProofFile.php mscrUploadProofFile_758(1:)
    }
  }
}?></td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td align="right" valign="top">Leter From Editor:</td>
                <td><label for="txtLeterFromEditor"></label>
                  <input name="txtLeterFromEditor" type="file" id="txtLeterFromEditor" size="40" />
                  <br />
                  <?php
if (ValidatedField('mscrUploadProofFile_758','mscrUploadProofFile_758'))  {
  if ((strpos((",".ValidatedField("mscrUploadProofFile_758","mscrUploadProofFile_758").","), "," . "2" . ",") !== false || "2" == ""))  {
    if (!(false))  {
?>
                    <span class="validation_text">Please select Letter from Editor file.</span>
                  <?php //WAFV_Conditional mscr_UploadProofFile.php mscrUploadProofFile_758(2:)
    }
  }
}?></td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="btnUploadProofFile" id="btnUploadProofFile" value="   Upload Proof File   " />

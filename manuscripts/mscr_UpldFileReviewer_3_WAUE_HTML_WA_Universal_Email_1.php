...
if ("" == "") // Trigger
{
  ...
  $WA_fieldValuesStr = "".$_SESSION['UserFirstName']  ." ".$_SESSION['UserLastName']  .", ".$_SESSION['UserEmail']  ."" . $WA_AB_Split . "".((isset($_SERVER["REMOTE_ADDR"]))?$_SERVER["REMOTE_ADDR"]:"")  ."" . $WA_AB_Split . "Upload File From Reviewer No 3 ";
...
<p>Dear Dr. <?php echo $row_rsUpldFileReviewer3['AutorEmail']?>,</p>
<p>We would like to inform you that your manuscript <strong><?php echo $row_rsUpldFileReviewer3['mscrCodeU']?></strong> has been reviewed from <strong>Reviewer No 3.</strong> Checklist was attached to you and uploaded to the system.<br />

    ...
    <div id="content"><!-- InstanceBeginEditable name="mainContent" -->
      ...
      <div id="mainContent">
        <form id="form1" name="form1" method="post" action="">
          <span class="title">Upload Files From Reviewer</span>
          <hr />
          <p>Thank you for your review of the manuscript .<br />
Your cooperation is greatly appreciated. Your review is attached to "Manuscripts for review".</p>
        </form>
      </div>
    <!-- InstanceEndEditable --></div>
  </div>

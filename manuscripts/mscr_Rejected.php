...
<!-- InstanceBeginEditable name="LeftSidebar" -->
  ...
  <div id="mainContent"><span class="title">Rejected Manuscripts</span>
    <hr />
...
?>
      <div id="all_manuscripts">
        <form id="form1" name="form1" method="post" action="">
          ...
          <tr>
            <td height="14" colspan="4" align="left" valign="middle" bgcolor="#FFFFFF"><a href="../download/mnscrCorrectedFile.php?mnscrpt_id=<?php echo $rsMnscrpt->getColumnVal('mscrID'); ?>"><?php echo $rsMnscrpt->getColumnVal('mscrCorrected'); ?></a> ( <?php echo $rsMnscrpt->getColumnVal('mscrDateFileCorrected'); ?> )</td>
          ...
          <tr>
            ...
            <td align="center" valign="middle" bgcolor="#FFFFFF"><a href="mscr_UploadProofFile.php?mscr_id=<?php echo $rsMnscrpt->getColumnVal('mscrID'); ?>">Proof</a></td>
          </tr>
          </table>
        </form>
      </div>

          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="2">
            ...
            <tr>
              ...
              <td colspan="3"><select name="txtReviewer_2" id="txtReviewer_2">
                <option value="" <?php if (!(strcmp("", $row_rsMnscrpt['mscrReviewer_2']))) {echo "selected=\"selected\"";} ?>>Select reviewer ...</option>
                <?php
do {  
?>
...
?>
              ...
              <td width="1%">&nbsp;</td>
              <td width="1%">&nbsp;</td>
              <td colspan="2"><a href="mscr_Reminder_2.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']; ?>">Reminder</a></td>
            </tr>
            <tr>

...
<ul>
        ...
        <li><a href="../users/users_LogIn.php" class="current">Login</a></li>
...
<!-- InstanceEndEditable --></div>
    ...
    <span class="title">Submit Manuscript</span>
  
    <div id="mainContent">
    <form id="form1" name="form1" method="post" action="">
      <p>Thank you for your submited Manuscript.<br />
        <strong>You have an email</strong> for instructions. <br />
        Other mail was sent to editor for information.<br />
        You may go to your <a href="mscr_Index.php">submited manuscript </a>now. </p>
</form>
</div>
  <!-- InstanceEndEditable --></div>
  </div>

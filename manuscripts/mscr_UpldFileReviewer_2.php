...
if ("" == "") // Trigger
{
  ...
  $WA_fieldValuesStr = "".$_SESSION['UserFirstName']  ." ".$_SESSION['UserLastName']  .", ".$_SESSION['UserEmail']  ."" . $WA_AB_Split . "".((isset($_SERVER["REMOTE_ADDR"]))?$_SERVER["REMOTE_ADDR"]:"")  ."" . $WA_AB_Split . "Enter site \"Uoload File From Reviewer No 2\"";
...
if (WA_DFP_AnyUploadSuccess()) // Trigger
{
  $WA_connection = $localhost;
  $WA_table = "log";
  $WA_sessionName = "uplRevie2";
  $WA_redirectURL = "";
  if (function_exists("rel2abs")) $WA_redirectURL = $WA_redirectURL?rel2abs($WA_redirectURL,dirname(__FILE__)):"";
  $WA_keepQueryString = false;
  $WA_fieldNamesStr = "logUser|logIP|logContent";
  $WA_fieldValuesStr = "".$_SESSION['UserFirstName']  .", ".$_SESSION['UserEmail']  ."" . $WA_AB_Split . "".((isset($_SERVER["REMOTE_ADDR"]))?$_SERVER["REMOTE_ADDR"]:"")  ."" . $WA_AB_Split . "Success upload files from Reviewer No 2";
  $WA_columnTypesStr = "',none,''|',none,''|',none,''";
  $WA_fieldNames = explode("|", $WA_fieldNamesStr);
  $WA_fieldValues = explode($WA_AB_Split, $WA_fieldValuesStr);
  $WA_columns = explode("|", $WA_columnTypesStr);
    ...
    <div id="mainContent">
      <div id="form1_ProgressWrapper">
        <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <span class="title">Upload File From Reviewer No 2</span>
          <hr />
          <br />
          <table width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr id="row1" >
              <td width="28%" height="23" align="center" valign="middle" bgcolor="#FEED77"><?php echo $row_rsUpldFileReviewer2['mscrCodeU']; ?></td>
              <td width="48%" valign="middle" bgcolor="#CCCCCC"><?php echo $row_rsUpldFileReviewer2['mscrFullTitle']; ?></td>
              <td width="24%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo $row_rsUpldFileReviewer2['mscrUpldDate']; ?></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Author:</td>
              <td><?php echo $row_rsUpldFileReviewer2['AutorFullName']; ?></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Reviewer:</td>
              <td><?php echo $row_rsUpldFileReviewer2['mscrReviewerFullName_2']; ?></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr id="togglefile">
              ...
              <td><input name="txtReviewerFile1" type="file" id="txtReviewerFile1" size="40" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
...
if (ValidatedField('mscrUpldFileReviewer2_671','mscrUpldFileReviewer2_671'))  {
  if ((strpos((",".ValidatedField("mscrUpldFileReviewer2_671","mscrUpldFileReviewer2_671").","), "," . "1" . ",") !== false || "1" == ""))  {
    if (!(false))  {
?>
                  Please select your checklist file to upload.
  <?php //WAFV_Conditional mscr_UpldFileReviewer_2.php mscrUpldFileReviewer2_671(1:)
    }
  }
}?></td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><span id="sprycheckbox1"><span class="checkboxRequiredMsg">Please make a selection.</span></span>
                <select name="checkRecomendation" id="checkRecomendation">
            ...
            <tr>
              ...
              <td><span class="validation_text">
                <?php
if (ValidatedField('mscrUpldFileReviewer2_671','mscrUpldFileReviewer2_671'))  {
  if ((strpos((",".ValidatedField("mscrUpldFileReviewer2_671","mscrUpldFileReviewer2_671").","), "," . "2" . ",") !== false || "2" == ""))  {
    if (!(false))  {
?>
                  Please select recomendation.
  <?php //WAFV_Conditional mscr_UpldFileReviewer_2.php mscrUpldFileReviewer2_671(2:)
    }
  }
}?>
              </span></td>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsUpldFileReviewer2);
?>

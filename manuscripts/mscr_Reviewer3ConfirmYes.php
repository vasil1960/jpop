...
$query_rsConfirmYes = sprintf("SELECT mnscrpts.mscrID, mnscrpts.mscrCodeU, mnscrpts.mnscrCodeConfirmYes_3 FROM mnscrpts WHERE mnscrpts.mscrID=%s AND mnscrpts.mnscrCodeConfirmYes_3=%s", GetSQLValueString($colname1_rsConfirmYes, "int"),GetSQLValueString($colname2_rsConfirmYes, "text"));
...
if (!($totalRows_rsConfirmYes == 0)) // Trigger
{
  ...
  $WA_fieldNamesStr = "mnscConfirmReviewer_3|mnscrCodeConfirmYes_3|mnscrCodeConfirmNo_3|mnscrDateConfirm_3";

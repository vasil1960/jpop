...
<p>Dear Dr. <?php echo $row_rsReviewer_3['ReviewerFullName']?>,<br />
  ...
  <br />
  <a href="http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer3ConfirmYes.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']?>&code=<?php echo $_SESSION['confirmYes']?>">I agree to review this submission.</a>
  
  <br />
  <br />
  If you do not have time to do this, or do not feel qualified, please click on this link: <br />
  <br />
  <a href="http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer3ConfirmNo.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']?>&code=<?php echo $_SESSION['confirmNo']?>">I decline to review this submission.</a>

...
<p><br />
  ...
  <br />
  <a href="http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer1ConfirmNo.php?mnscrpt_id=<?php echo $row_rsMnscrpt['mscrID']?>&code=<?php echo $_SESSION['confirmNo']?>">I decline to review this submission.</a>

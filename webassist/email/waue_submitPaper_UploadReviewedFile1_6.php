...
$MailSubject     = "Reviewered File from";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_submitPaper_UploadReviewedFile1_6");

if (isset($_SESSION["waue_submitPaper_UploadReviewedFile1_6_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_submitPaper_UploadReviewedFile1_6";
  $MailLogBindings->Success->MailRef = "waue_submitPaper_UploadReviewedFile1_6";
  $MailLogBindings->Failure->MailRef = "waue_submitPaper_UploadReviewedFile1_6";
  $MailLogBindings->processLog(($_SESSION["waue_submitPaper_UploadReviewedFile1_6_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
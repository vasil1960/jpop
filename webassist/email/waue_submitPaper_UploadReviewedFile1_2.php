...
$MailSubject     = "Reviewered file from ".$row_rsReviewedFile1['paperReviewer1FullName']  ."";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_submitPaper_UploadReviewedFile1_2");

if (isset($_SESSION["waue_submitPaper_UploadReviewedFile1_2_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_submitPaper_UploadReviewedFile1_2";
  $MailLogBindings->Success->MailRef = "waue_submitPaper_UploadReviewedFile1_2";
  $MailLogBindings->Failure->MailRef = "waue_submitPaper_UploadReviewedFile1_2";
  $MailLogBindings->processLog(($_SESSION["waue_submitPaper_UploadReviewedFile1_2_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
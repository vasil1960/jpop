...
$MailSubject     = "Manuscript ".$row_rsMnscrpt['mscrCodeU']  ." for review";
...
//Attachment Entries
  $WA_MailObject = WAUE_AddAttachment($WA_MailObject,"../files/manuscripts/".$row_rsMnscrpt['mscrFileName']  ."");
  $WA_MailObject = WAUE_AddAttachment($WA_MailObject,"../files/attach/Checklist.doc");
  $WA_MailObject = WAUE_AddAttachment($WA_MailObject,"../files/attach/Instructions_for_reviewer.doc");
...
$MailBody = $MailBody .  $row_rsReviewer_3['ReviewerFullName'];
$MailBody = $MailBody . ",<br />\r\n";
$MailBody = $MailBody . "  <br />\r\n";
$MailBody = $MailBody . "  In view of your expertise I would be very   grateful if you could review the following manuscript which has been   submitted to Online Manuscript Submission,            Review and Tracking System            for the journal            Propagation of Ornamental Plants.<br />\r\n";
$MailBody = $MailBody . "  <br />\r\n";
...
$MailBody = $MailBody . "  <br />\r\n";
$MailBody = $MailBody . "  <a href=\"http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer3ConfirmYes.php?mnscrpt_id=";
...
$MailBody = $MailBody . "  <br />\r\n";
$MailBody = $MailBody . "  <a href=\"http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer3ConfirmNo.php?mnscrpt_id=";
$MailBody = $MailBody .  $row_rsMnscrpt['mscrID'];
$MailBody = $MailBody . "&code=";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_mscr_SendToReviewerNo3_1");

if (isset($GLOBALS["waue_mscr_SendToReviewerNo3_1_Status"])) {
  $MailLogBindings = new WAUE_Log_Bindings();
  //Start Log Bindings
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_mscr_SendToReviewerNo3_1";
  $MailLogBindings->Success->MailRef = "waue_mscr_SendToReviewerNo3_1";
  $MailLogBindings->Failure->MailRef = "waue_mscr_SendToReviewerNo3_1";
  $MailLogBindings->processLog(($GLOBALS["waue_mscr_SendToReviewerNo3_1_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
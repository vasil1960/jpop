...
$MailBody        = "";
$MailImportance  = "";
$MailFrom        = "info@hghd.com";
$MailSubject     = "Veriewed File";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_submitPaper_UploadReviewedFile1_8");

if (isset($_SESSION["waue_submitPaper_UploadReviewedFile1_8_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_submitPaper_UploadReviewedFile1_8";
  $MailLogBindings->Success->MailRef = "waue_submitPaper_UploadReviewedFile1_8";
  $MailLogBindings->Failure->MailRef = "waue_submitPaper_UploadReviewedFile1_8";
  $MailLogBindings->processLog(($_SESSION["waue_submitPaper_UploadReviewedFile1_8_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
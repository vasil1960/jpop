...
$MailBody = $MailBody .  $row_rsReviewer_2['ReviewerFullName'];
...
$MailBody = $MailBody . "  <br />\r\n";
$MailBody = $MailBody . "  <a href=\"http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer2ConfirmYes.php?mnscrpt_id=";
...
$MailBody = $MailBody . "  <br />\r\n";
$MailBody = $MailBody . "  <a href=\"http://jpop.klaro-bg.com/manuscripts/mscr_Reviewer2ConfirmNo.php?mnscrpt_id=";
$MailBody = $MailBody .  $row_rsMnscrpt['mscrID'];
$MailBody = $MailBody . "&code=";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_mscr_SendToReviewerNo2_1");

if (isset($GLOBALS["waue_mscr_SendToReviewerNo2_1_Status"])) {
  $MailLogBindings = new WAUE_Log_Bindings();
  //Start Log Bindings
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_mscr_SendToReviewerNo2_1";
  $MailLogBindings->Success->MailRef = "waue_mscr_SendToReviewerNo2_1";
  $MailLogBindings->Failure->MailRef = "waue_mscr_SendToReviewerNo2_1";
  $MailLogBindings->processLog(($GLOBALS["waue_mscr_SendToReviewerNo2_1_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
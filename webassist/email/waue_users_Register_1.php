...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_users_Register_1");

if (isset($_SESSION["waue_users_Register_1_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_users_Register_1";
  $MailLogBindings->Success->MailRef = "waue_users_Register_1";
  $MailLogBindings->Failure->MailRef = "waue_users_Register_1";
  $MailLogBindings->processLog(($_SESSION["waue_users_Register_1_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
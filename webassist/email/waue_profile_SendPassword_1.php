...
$MailBody        = "";
$MailImportance  = "";
$MailFrom        = "Journal POP|WA|infi@journal-pop.org";
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_profile_SendPassword_1");

if (isset($_SESSION["waue_profile_SendPassword_1_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_profile_SendPassword_1";
  $MailLogBindings->Success->MailRef = "waue_profile_SendPassword_1";
  $MailLogBindings->Failure->MailRef = "waue_profile_SendPassword_1";
  $MailLogBindings->processLog(($_SESSION["waue_profile_SendPassword_1_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_submitPaper_UploadReviewedFile1_3");

if (isset($_SESSION["waue_submitPaper_UploadReviewedFile1_3_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_submitPaper_UploadReviewedFile1_3";
  $MailLogBindings->Success->MailRef = "waue_submitPaper_UploadReviewedFile1_3";
  $MailLogBindings->Failure->MailRef = "waue_submitPaper_UploadReviewedFile1_3";
  $MailLogBindings->processLog(($_SESSION["waue_submitPaper_UploadReviewedFile1_3_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
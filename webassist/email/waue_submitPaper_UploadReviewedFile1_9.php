...
$WA_MailObject = WAUE_SendMail($WA_MailObject,$MailAttachments,$MailBCC,$MailCC,$MailTo,$MailImportance,$MailFrom,$MailSubject,$MailBody,"waue_submitPaper_UploadReviewedFile1_9");

if (isset($_SESSION["waue_submitPaper_UploadReviewedFile1_9_Status"])) {
  ...
  //End Log Bindings
  $MailLogBindings->SuccessOrFailure->MailRef = "waue_submitPaper_UploadReviewedFile1_9";
  $MailLogBindings->Success->MailRef = "waue_submitPaper_UploadReviewedFile1_9";
  $MailLogBindings->Failure->MailRef = "waue_submitPaper_UploadReviewedFile1_9";
  $MailLogBindings->processLog(($_SESSION["waue_submitPaper_UploadReviewedFile1_9_Status"] == "Failure"));
}
$WA_MailObject = null;
?>
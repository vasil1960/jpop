...
?>
<?php
$rsAbstract = new WA_MySQLi_RS("rsAbstract",$localhost_i,1);
$rsAbstract->setQuery("SELECT mnscrpts.mscrID, mnscrpts.mscrAbstract, mnscrpts.mscrCodeU, mnscrpts.mscrUpldDate, mnscrpts.mscrFullTitle, users.UserID, CONCAT(users.UserFirstName,' ', users.UserLastName) AS AutorFullName FROM mnscrpts, users WHERE mnscrpts.mscrID=? AND mnscrpts.mscrAutorID=users.UserID");
$rsAbstract->bindParam("i", "".($_GET['mnscrpt_id'])  ."", "-1"); //colname
$rsAbstract->execute();
?>
<?php
    ...
    <div id="content"><!-- InstanceBeginEditable name="mainContent" -->
      ...
      <div id="mainContent">
        <form id="form1" name="form1" method="post" action="">
           <span class="title">Abstract</span><hr /><br />
           <table width="70%" border="0" cellspacing="3" cellpadding="0">
             <tr>
               <td width="11%"><strong>No.:</strong></td>
               <td width="89%"><?php echo $rsAbstract->getColumnVal('mscrCodeU'); ?></td>
             </tr>
             <tr>
               <td><strong>Title:</strong></td>
               <td><?php echo $rsAbstract->getColumnVal('mscrFullTitle'); ?></td>
             </tr>
             <tr>
               <td><strong>Autor:</strong></td>
               <td><?php echo $rsAbstract->getColumnVal('AutorFullName'); ?></td>
             </tr>
             <tr>
               <td><strong>Date:</strong></td>
               <td><?php echo $rsAbstract->getColumnVal('mscrUpldDate'); ?></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             ...
             <tr>
               ...
               <td><?php echo $rsAbstract->getColumnVal('mscrAbstract'); ?></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
